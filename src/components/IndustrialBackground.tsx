...
export function IndustrialBackground() {
  ...
  return (
    <div ref={containerRef} className="fixed inset-0 -z-20 overflow-hidden bg-[#0B0F1A]">
      ...
      {/* Atmospheric Glows */}
      <div className="absolute top-[-10%] right-[-10%] w-[800px] h-[800px] bg-accent/10 blur-[150px] rounded-full animate-pulse" />
      <div className="absolute bottom-[-10%] left-[-10%] w-[600px] h-[600px] bg-gold-muted blur-[120px] rounded-full" />
